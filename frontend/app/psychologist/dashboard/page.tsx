      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-8 lg:py-12">
        ...
        {activeTab === "students" && (
          <div className="space-y-6">
            ...
            {/* Students List */}
            <div className="glass-card p-8 rounded-2xl">
              <h4 className="text-lg font-bold text-on-background mb-6">All Students</h4>
              ...
              {students.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-500">No students yet. Create your first student profile above.</p>
                </div>
              ) : (
                <div className="overflow-x-auto">
                  <table className="w-full">
                        ...
                        <tr key={student.id} className="border-b border-slate-100 hover:bg-slate-50">
                          ...
                          <td className="py-4 px-4">
                            {student.has_active_assignment ? (
                              <span className="px-3 py-1 rounded-lg text-xs font-bold border bg-blue-100 text-blue-700 border-blue-200">
                                Active Assessment
                              </span>
                            ) : (
