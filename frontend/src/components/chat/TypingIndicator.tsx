...
export default function TypingIndicator() {
  return (
    <div className="flex items-end gap-2.5 justify-start animate-fade-in" role="status" aria-label="Preparing response">
      {/* Bot Avatar */}
      ...
      <div className="bg-white rounded-2xl rounded-bl-sm px-5 py-3.5 shadow-sm border border-gray-150">
        <div className="flex items-center gap-1">
          <span className="typing-dot inline-block w-1.5 h-1.5 rounded-full bg-indigo-400/70" />
          <span className="typing-dot inline-block w-1.5 h-1.5 rounded-full bg-indigo-400/70" />
          <span className="typing-dot inline-block w-1.5 h-1.5 rounded-full bg-indigo-400/70" />
        </div>
      </div>
