...
export default function JsonViewer({ data }: JsonViewerProps) {
  ...
  return (
    <div className="relative">
      <button type="button" onClick={handleCopy} className="absolute top-2 right-2 z-10 px-3 py-1 text-[11px] font-medium rounded-md bg-white/10 text-slate-300 hover:bg-white/20 transition-colors">
        {copied ? "Copied!" : "Copy"}
      </button>
